...
const mockReservations: Reservation[] = [
  ...
  },
  {
    ...
    restaurantImage:
      "https://images.unsplash.com/photo-1544148103-0773bf10d330?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzV8fHJlc3RhdXJhbnR8ZW58MHx8MHx8fDA%3D",
    date: "22/05/2025",
    time: "20:00",
    partySize: 4,
    status: "pending",
  ...
  },
  {
    ...
    restaurantImage:
      "https://images.unsplash.com/photo-1579027989536-b7b1f875659b?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHJlc3RhdXJhbnR8ZW58MHx8MHx8fDA%3D",
    date: "03/06/2025",
    time: "13:00",
    partySize: 3,
    status: "canceled",
...
export const createReservation = (
  reservationData: Omit<Reservation, "id" | "status">
): Promise<Reservation> => {
  return new Promise((resolve) => {
    setTimeout(() => {
...
export const getRestaurantReservations = (
  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      const restaurantReservations = mockReservations.filter(
