  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="hero-section relative h-[500px] flex items-center">
        ...
        <div className="container mx-auto px-6 relative z-10 text-white flex justify-center">
          <div className="max-w-2xl text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Reserve seu restaurante favorito
            </h1>
            <p className="text-lg md:text-xl mb-8">
              Encontre e reserve os melhores restaurantes da sua região com
              facilidade
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Busque restaurantes por local, cozinha ou nome
              </p>
            </div>
            <div className="text-center">
              <div className="bg-purple-100 h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Escolha o horário e o número de pessoas
              </p>
            </div>
            <div className="text-center">
              <div className="bg-purple-100  h-16 w-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Vá ao restaurante e aproveite sua refeição
              </p>
            </div>
          </div>
        </section>
