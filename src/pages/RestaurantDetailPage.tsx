  ...
  const handleReservation = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Sua reserva foi solicitada com sucesso! Aguarde a confirmação do restaurante.",
      });

      navigate("/meu-restaurante/calendario");
    } catch (error) {
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center">
                ...
                <span>
                  Aberto das {restaurant.openingHours.opens} às{" "}
                  {restaurant.openingHours.closes}
                </span>
              </div>
            </div>
          </div>
