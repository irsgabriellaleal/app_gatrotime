    ...
    const fetchReservations = async () => {
      ...
      try {
        ...
        toast({
          ...
          description:
            "Não foi possível buscar suas reservas. Por favor, tente novamente.",
        });
      } finally {
        setIsLoading(false);
      }
  ...
  const handleCancelReservation = async (id: string) => {
    try {
      ...
      toast({
        ...
        description:
          "Não foi possível cancelar sua reserva. Por favor, tente novamente.",
      });
    }
  };
            ...
            <Tabs defaultValue="upcoming" className="mb-8">
              <TabsList>
                <TabsTrigger value="upcoming">
                  Ativas ({upcoming.length})
                </TabsTrigger>
                <TabsTrigger value="past">
                  Canceladas ({past.length})
                </TabsTrigger>
              </TabsList>
                ...
                {upcoming.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <Link to="/restaurantes">
                      <Button className="bg-purple-100 hover:bg-restaurant-primary/90">
